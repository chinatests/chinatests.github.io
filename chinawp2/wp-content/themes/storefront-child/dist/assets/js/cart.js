jQuery(document).on('click', '.cz-update-variation-edit', function(){
    ...
    jQuery.ajax({
        ...
        url: ajax_wc_update_variation_in_cart.ajax_url,
        ...
        success: function( result ) {
            ...
            if ( form_present == 0 ) {
                ...
                current_item_product.after('<tr class="new_row_'+cart_item_key+'" id="new_row"><td colspan="6"><table class="update_variation_form woocommerce-product-gallery__image"><tr><td id="thumbnail_'+cart_item_key+'" class="WOO_CK_WUVIC_thumbnail"></td><td class="variations">'+result+'</td></tr></table></td></tr>').hide();
    ...
    jQuery.ajax({
        ...
        success: function(response) {
            ...
            if( jQuery('div.woocommerce-message').length == 0 ){
                ...
                jQuery('div.entry-content div.woocommerce').prepend('<div class="woocommerce-message">'+ajax_wc_update_variation_in_cart.cart_updated_text+'</div>');
